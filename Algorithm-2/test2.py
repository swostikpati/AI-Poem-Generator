# -*- coding: utf-8 -*-
"""
Created on Sun Oct  9 15:16:18 2022
...
file = open('poem1input.txt', 'r')
for line in file:
    for word in line.split():
        p1_lines.append(word + " ") #adds words from poem into the array
        #print (word)
...
for i in range (len(final_file)):
    ...
    del final_file[random_word] #to avoid repetition of words
...
while current_line < len(to_store):
    ...
    final_to_print.append("")     #should be /n
...
#Printing into final file - not required that much
