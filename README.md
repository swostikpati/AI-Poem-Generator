# AI-Poem-Generator
Final Project for the class Thousand and One Nights
...
its builder and own my regrets to a where myrtle daisy rose and gillyflowers grow if the house could know who came this way it would thrill at the news and kiss the ground as if to greet its guest as if to say well met and welcome to a gracious mind trays of sweets pair surpass beg return return”
